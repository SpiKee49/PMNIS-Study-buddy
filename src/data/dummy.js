...
export const students = [
  ...
  },
  {
    ...
    field: 'Tech & CS',
    specializations: ['Convolutional Neural Networks', 'Activation Functions', 'Loss Functions', 'CNN Architecture', 'CNN Training', 'Model Evaluation', 'Deep Learning Architectures', 'Recurrent Networks'],
    schoolType: 'University',
    learningStyle: 'Visual',
    studyVibe: 'Discussion',
  ...
  },
  {
    ...
    field: 'Tech & CS',
    specializations: ['Gradient Descent & Optimization', 'Overfitting & Regularization', 'Neural Network Fundamentals', 'Regularisation', 'Model Training', 'CNN Training', 'Transformers', 'Generative Models'],
    schoolType: 'University',
    learningStyle: 'Visual',
    studyVibe: 'Discussion',
